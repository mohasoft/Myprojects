...
$sql = "SELECT * FROM utilisateurs, produits WHERE utilisateurs.id_user = produits.id_user and validation=true and produits.id_prod='".$id_prod."'";
